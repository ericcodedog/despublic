...
import { Gauge, WordCloud, Liquid, RingProgress, Pie } from '@ant-design/charts';
import type { WordCloudData } from '@antv/g2plot/esm/plots/word-cloud/layer';

import { GridContent } from '@ant-design/pro-layout';
import numeral from 'numeral';
import Map from './components/Map';
//import pointLayer from './components/Map1';
import ActiveChart from './components/ActiveChart';
import ActiveChart1 from './components/ActiveChart1';
      ...
      <>
        <Row gutter={24}>
          ...
          <Col xl={6} lg={24} md={24} sm={24} xs={24}>
            ...
            <Card title="消费情况预测" style={{ marginBottom: 24 }} bordered={false}>
              <ActiveChart1 />
            </Card>
            <Card
              title="券核效率"
